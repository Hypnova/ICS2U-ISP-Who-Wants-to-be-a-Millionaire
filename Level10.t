body proc display10
    ...
    nextLevel := 11
    answerRight := 0
    var questionLVL10 : array 1 .. 3 of string := init ("Graphite is a form of what chemical element?", "On a sailboat, a mizzen is a type of what?", "Henry VIII split from the Roman Catholic Church after it refused to annul his marriage to whom?")
    Font.Draw (questionLVL10 (number), 58, 150, font4, 0)
    if questionLVL10 (number) = "Graphite is a form of what chemical element?" then
	helpAnswer := 1
	Font.Draw ("a) Carbon", 115, 75, font1, 0)
	Font.Draw ("b) Lead", 395, 75, font1, 0)
	Font.Draw ("c) Iron", 115, 25, font1, 0)
	Font.Draw ("d) Silicon", 395, 25, font1, 0)
	loop
    ...
    elsif questionLVL10 (number) = "On a sailboat, a mizzen is a type of what?" then
	helpAnswer := 1
	Font.Draw ("a) Sail", 115, 75, font1, 0)
	Font.Draw ("b) Rudder", 395, 75, font1, 0)
	Font.Draw ("c) Keel", 115, 25, font1, 0)
	Font.Draw ("d) Tiller", 395, 25, font1, 0)
	loop
	    mousewhere (mouseX, mouseY, buttonP)
	    if mouseX > 90 and mouseX < 290 and mouseY > 60 and mouseY < 120 and buttonP = 1 then
		finalRight
    ...
    elsif questionLVL10 (number) = "Henry VIII split from the Roman Catholic Church after it refused to annul his marriage to whom?" then
	helpAnswer := 1
	Font.Draw ("a) Anne Boleyn", 115, 75, font7, 0)
	Font.Draw ("b) Jane Seymour", 395, 75, font7, 0)
	Font.Draw ("c) Anne of Cleves", 115, 25, font7, 0)
	Font.Draw ("d) Catherine of Aragon", 395, 25, font7, 0)
	loop
	    mousewhere (mouseX, mouseY, buttonP)
	    if mouseX > 90 and mouseX < 290 and mouseY > 60 and mouseY < 120 and buttonP = 1 then
		finalRight
