body proc display4
    ...
    nextLevel := 5
    answerRight := 0
    var questionLVL4 : array 1 .. 3 of string := init ("Susan Powter's popular fitness regiment and 1993 book is called 'Stop the' what?", "In the 1950s TV series 'The Little Rascals,' who has a cowlick in his hair?", "Which of these weapons was designed to fit on the end of a rifle barrel?")
    Font.Draw (questionLVL4 (number), 65, 150, font4, 0)
    if questionLVL4 (number) = "Susan Powter's popular fitness regiment and 1993 book is called 'Stop the' what?" then
	helpAnswer := 2
	Font.Draw ("a) Presses", 115, 75, font1, 0)
	Font.Draw ("b) Insanity", 395, 75, font1, 0)
	Font.Draw ("c) Yo-Yo Dieting!", 115, 25, font1, 0)
	Font.Draw ("d) Drooling!", 395, 25, font1, 0)
	loop
    ...
    elsif questionLVL4 (number) = "In the 1950s TV series 'The Little Rascals,' who has a cowlick in his hair?" then
	helpAnswer := 2
	Font.Draw ("a) Buckwheat", 115, 75, font1, 0)
	Font.Draw ("b) Alfalfa", 395, 75, font1, 0)
	Font.Draw ("c) Froggy", 115, 25, font1, 0)
	Font.Draw ("d) Stymie", 395, 25, font1, 0)
	loop
	    mousewhere (mouseX, mouseY, buttonP)
	    if mouseX > 90 and mouseX < 290 and mouseY > 60 and mouseY < 120 and buttonP = 1 then
		finalWrong
    ...
    elsif questionLVL4 (number) = "Which of these weapons was designed to fit on the end of a rifle barrel?" then
	helpAnswer := 2
	Font.Draw ("a) Machete", 115, 75, font1, 0)
	Font.Draw ("b) Bayonet", 395, 75, font1, 0)
	Font.Draw ("c) Pike", 115, 25, font1, 0)
	Font.Draw ("d) Mace", 395, 25, font1, 0)
	loop
	    mousewhere (mouseX, mouseY, buttonP)
	    if mouseX > 90 and mouseX < 290 and mouseY > 60 and mouseY < 120 and buttonP = 1 then
		finalWrong
